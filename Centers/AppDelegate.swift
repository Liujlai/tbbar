...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    fileprivate func createKeyWindow() {
        ...
        if (UserDefaults.standard.object(forKey: "ifO") as? Bool == nil ? false : UserDefaults.standard.object(forKey: "ifO") as! Bool) != true {
...
//        let navgationController = UINavigationController(rootViewController: CustomTabBarVC());
